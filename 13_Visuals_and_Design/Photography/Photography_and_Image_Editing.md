...
| **Narrative Select**                           | Manual         | Main culling tool for fast photo selection sessions.                                          |
...
| Software        | Install Method | What it does / Why I need it                                     |
| --------------- | -------------- | ---------------------------------------------------------------- |
| **digiKam**     | UniGetUI       | Photo management, tagging, and library organization.             |
| **Lightedium**  | Manual         | Face recognition support used alongside photo library workflows. |
| **PhotoDemon**  | PortableApps   | Lightweight image editor for quick photo fixes.                  |
...
| Software                   | Install Method | What it does / Why I need it                               |
| -------------------------- | -------------- | ---------------------------------------------------------- |
| **Caesium**                | PortableApps   | Compress images to reduce size with minimal quality loss.  |
